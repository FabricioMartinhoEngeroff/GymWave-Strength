...
Calcula e exibe automaticamente o peso médio recomendado para aquele exercício abaixo do componente selecte vira uma mensagem motivadora dizendo como sugestão deveria por esse peso para cada serie e realizar 
