            ...
            {editandoIdx === idx ? (
              ...
              <>
                ...
                <p style={{ fontSize: 13, color: "#888" }}>
                  <FaStar className="inline-block mr-1" size={14} />Série <FaSyncAlt className="inline-block mx-1" size={14} />Reps · <FaDumbbell className="inline-block mx-1" size={14} />Peso
                </p>
                {l.series.map(s => (
                  <p
                    key={s.serie}
                ...
                {l.obs && (
                  <p style={{ fontSize: 13, color: "#555", borderTop: "1px solid #eee", marginTop: 12, paddingTop: 10 }}>
                    <FaFileAlt className="inline-block mr-1" size={14} /> <strong>Observações:</strong> {l.obs}
                  </p>
                )}
                <div
                  style={{
