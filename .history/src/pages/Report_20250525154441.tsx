          ...
          >
            {editandoIdx === idx ? (
              ...
              <>
                ...
                <p>
                  <Barbell weight="duotone" className="inline-block mr-1" size={16} />
                ...
                <p style={{ fontSize: 13, color: "#888" }}>
                  ...
                  Série <ArrowsClockwise weight="duotone" className="inline-block mx-1" size={14} />Reps ·{" "}
                  <Dumbbell weight="duotone" className="inline-block mx-1" size={14} />
                  Peso
                </p>
                {l.series.map(s => (
                  <p
                ...
                {l.obs && (
                  ...
                  >
                    <FileText weight="duotone" className="inline-block mr-1" size={14} />{" "}
