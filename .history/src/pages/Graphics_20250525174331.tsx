...
export default function Graphics() {
  ...
  return (
    <div style={{
      padding: "0 8px 24px",       // margem lateral de 8px
        ...
        return (
          <div
            ...
            style={{
              ...
              margin: "0 auto 24px",    // centraliza e espaça entre cards
          ...
          >
            ...
            <div style={{ width:"100%", height:isMobile?260:360, marginTop: 12 }}>
              <ResponsiveContainer width="100%" height="100%">
                <ComposedChart
                  data={dados}
                  margin={{ top:16, right:16, left:48, bottom:isMobile?40:60 }}
                >
                  ...
                  <Legend verticalAlign="top" wrapperStyle={{ color:"#fff", paddingTop: 8 }} />
