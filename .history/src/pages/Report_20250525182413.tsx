...
export default function Report() {
  ...
  return (
  <div style={{ minHeight: "100vh", background: "#f3f4f6", padding: 20, boxSizing: "border-box" }}>
    <h1 style={{
      textAlign: "center",
      fontSize: 24,
      fontWeight: "bold",
        ...
        >
          {editandoIdx === idx ? (
            ...
            <>
              {/* Modo exibição */}
              <p>
                <CalendarBlankIcon size={16} weight="duotone" className="inline-block mr-1" />
                <strong>Data:</strong> {l.data}
              </p>
              <p>
                <BarbellIcon size={16} weight="fill" color="#EF4444" className="inline-block mr-1" />
                <strong>Exercício:</strong> {l.exercicio}
              </p>
              <p>
                <TagIcon size={16} weight="duotone" className="inline-block mr-1" />
                <strong>Ciclo:</strong> {l.ciclo}
              </p>
              <p style={{ fontSize: 13, color: "#888" }}>
                <StarIcon size={14} weight="fill" color="#FBBF24" className="inline-block mr-1" />
                Série <ArrowsClockwiseIcon size={14} weight="fill" color="#3B82F6" className="inline-block mx-1" />
                Reps · <BarbellIcon size={14} weight="fill" color="#EF4444" className="inline-block mx-1" />
                Peso
              </p>
              {l.series.map(s => (
                <p
              ...
              {l.obs && (
                <p style={{
                  ...
                  <FileTextIcon size={14} weight="duotone" className="inline-block mr-1" />
              ...
              <div style={{
                ...
                >
                  <PencilSimpleIcon size={16} weight="fill" color="#F59E0B" className="inline-block mr-1" />
                  Editar
                </button>
                <button
                  style={{
                ...
                >
                  <TrashIcon size={16} weight="duotone" className="inline-block mr-1" />
                  Excluir
                </button>
              </div>
            </>
