...
export default function Report() {
  ...
  const salvarEdicao = (idx: number) => {
    ...
    const cicloOriginal = CICLOS.find(
      (c) => c.titulo === novasLinhas[idx].ciclo
    )?.id;
          ...
          >
            ...
            {editandoIdx === idx ? (
              <>
                ...
                <button onClick={() => salvarEdicao(idx)} style={{ marginRight: "10px" }}>
              ...
              <>
                ...
                <p>
                  <Dumbbell className="inline-block mr-1" size={16} />
                ...
                <p style={{ fontSize: "13px", color: "#888" }}>
                  ...
                  Reps &nbsp;·&nbsp;
                  <Dumbbell className="inline-block mr-1" size={14} />
                  Peso
                </p>
