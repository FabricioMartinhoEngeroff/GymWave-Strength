              ...
              <>
                <div>
                  <label>
                    ...
                    <input
                      type="date"
                      value={linhaEditada.data || ""}
                      onChange={e =>
                        setLinhaEditada({ ...linhaEditada, data: e.target.value })
                      }
                ...
                <div>
                  <label>
                    ...
                    <input
                      type="text"
                      value={linhaEditada.obs || ""}
                      onChange={e =>
                        setLinhaEditada({ ...linhaEditada, obs: e.target.value })
                      }
                      style={{ marginLeft: 8, marginBottom: 8, width: "80%" }}
                    />
                  </label>
                </div>
                {linhaEditada.series &&
                  linhaEditada.series.map((serie, sidx) => (
                    <div key={sidx} style={{ marginBottom: 8 }}>
                      <label>
                        ...
                        <input
                          ...
                          value={serie.rep}
                          onChange={e => {
                            const novasSeries = [...linhaEditada.series!];
                            novasSeries[sidx] = {
                              ...novasSeries[sidx],
                              rep: e.target.value
                            };
                            setLinhaEditada({ ...linhaEditada, series: novasSeries });
                          }}
                ...
                <div style={{ display: "flex", gap: 10, marginTop: 10 }}>
                  ...
                  <button
                    ...
                    style={{ backgroundColor: "#e5e7eb", color: "#222" }}
                  >
                    Cancelar
                  </button>
                </div>
