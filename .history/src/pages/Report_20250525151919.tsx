            ...
            {editandoIdx === idx ? (
                ...
                {l.series.map((s, i) => (
                  <div key={i} style={{ marginBottom: 12 }}>
                    ...
                    <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", gap: 8 }}>
                      ...
                      <div style={{ flex: 1 }}>
                        <label style={{ display: "flex", alignItems: "center", fontSize: 12, color: "#555", marginBottom: 2 }}>
                          <Barbell weight="duotone" className="mr-1" size={14} />
                          Peso
                        </label>
                        <input
              ...
              <>
                ...
                <p style={{ fontSize: 13, color: "#888" }}>
                  ...
                  Série <ArrowsClockwise weight="duotone" className="inline-block mx-1" size={14} />Reps · <Barbell weight="duotone" className="inline-block mx-1" size={14} />Peso
                </p>
                {l.series.map(s => (
                  <p
                    key={s.serie}
