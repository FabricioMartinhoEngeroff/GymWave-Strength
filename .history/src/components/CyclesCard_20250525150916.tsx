// Componente CicloCard com ícones React no lugar dos emojis
...
export const CicloCard: React.FC<CicloCardProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <BarChart2 size={18} style={{ marginRight: "4px" }} />
        <span>{ciclo}</span>
        <span style={{ margin: "0 8px" }}>|</span>
        <Zap size={18} style={{ marginRight: "4px" }} />
        <span>{percentual}</span>
        <span style={{ margin: "0 8px" }}>|</span>
        <Repeat size={18} style={{ marginRight: "4px" }} />
        <span>{reps}</span>
      </div>
