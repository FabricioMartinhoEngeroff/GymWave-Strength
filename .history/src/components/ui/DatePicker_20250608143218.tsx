...
// --- Estilos do container externo com label ---
const Container = styled.div`
  position: relative;
  width: 100%;
  z-index: 0; /* Evita sobreposição com Select */
  ...
  label {
    ...
    padding: 0 4px;
    color: #444;
    z-index: 0; /* Mantém o label abaixo de outros campos */
  }
`;
...
// --- CustomInputWithIcon: compatível com ReactDatePicker ---
      ...
      popperModifiers={[
        {
          ...
          phase: "afterWrite",
          fn: ({ state }) => {
            state.elements.popper.style.zIndex = "10";
          },
        },
      ]}
    />
