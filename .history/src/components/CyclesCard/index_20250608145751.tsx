...
/>
  ...
  {exercicioSelecionado && sugestaoPeso > 0 ? (
    <>
      Com base nos seus registros anteriores e no ciclo atual, recomendamos iniciar este exercício com cerca de{" "}
...
/>
      ...
      <ButtonRow style={{ marginTop: "0px", flexDirection: "column", gap: "1px" }}>
        ...
        <Button
          ...
          style={{ color: "#b02a37", borderColor: "#b02a37",  backgroundColor: "#fce8e8"}}
        >
          Zerar Dados
        </Button>
      </ButtonRow>
