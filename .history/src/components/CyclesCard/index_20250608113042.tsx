...
export default function CycleCard({ value, onSave }: CycleCardProps) {
  ...
  <CardContainer as="form" onSubmit={(e) => { e.preventDefault(); salvar(); }}>
    <Bloco>
     ...
     <MensagemMotivacional>
  <strong>Com base no seu histórico de treinos e no ciclo selecionado</strong>, sugerimos iniciar com aproximadamente <span style={{ fontWeight: "bold", fontSize: "1.2em" }}>{sugestaoPeso} kg</span> neste exercício.
</MensagemMotivacional>
