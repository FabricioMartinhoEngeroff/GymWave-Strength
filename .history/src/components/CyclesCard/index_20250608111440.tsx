    ...
    <CardContainer as="form" onSubmit={(e) => { e.preventDefault(); salvar(); }}>
      <Bloco>
        ...
        <div style={{ marginTop: "24px" }}>
          <p style={{ fontWeight: "bold", fontSize: "16px" }}>Observações</p>
          <textarea
            rows={3}
          ...
          <div style={{ marginTop: "12px", display: "flex", justifyContent: "center" }}>
            ...
            >
              <CheckCircle size={16} weight="fill" color="#fff" style={{ marginRight: 8 }} />
              {salvando ? "Salvo!" : "Salvar"}
            </Button>
          </div>
        </div>

        <ButtonRow style={{ marginTop: "20px", flexDirection: "column", gap: "6px" }}>
