  ...
  return (
    <div className="bg-white p-4 rounded-xl shadow space-y-6 max-w-md mx-auto">
      ...
      <div className="flex flex-col gap-3">
        ...
        <Button type="button" onClick={abrirGraficos}>Ver Gráficos</Button>
        <Button type="button" onClick={abrirRelatorio}>Ver Relatório</Button>
        <Button type="button" onClick={resetarDados} variant="danger">Zerar Dados</Button>
      </div>
    </div>
  );
}
