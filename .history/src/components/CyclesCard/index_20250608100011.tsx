  ...
  return (
    <CardContainer as="form" onSubmit={(e) => { e.preventDefault(); salvar(); }}>
      <Bloco>
        ...
        <ButtonRow style={{ marginTop: "16px", flexDirection: "column", gap: "8px" }}>
          <Button type="button" variant="outline" onClick={exportarDados}>
            Exportar Dados
          </Button>
          <Button type="button" variant="outline" onClick={abrirGraficos}>
            Ver Gráficos
          </Button>
          <Button type="button" variant="outline" onClick={abrirRelatorio}>
            Ver Relatório
          </Button>
          <Button
            type="button"
