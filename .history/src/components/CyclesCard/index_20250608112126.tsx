...
export default function CycleCard({ value, onSave }: CycleCardProps) {
  ...
  <CardContainer as="form" onSubmit={(e) => { e.preventDefault(); salvar(); }}>
    <Bloco>
     ...
     <MensagemMotivacional>
 Com base no seu histórico de treinos e no ciclo selecionado, sugerimos iniciar com aproximadamente {sugestaoPeso} kg neste exercício. Lembre-se: a consistência constrói a força. 
     </MensagemMotivacional>
