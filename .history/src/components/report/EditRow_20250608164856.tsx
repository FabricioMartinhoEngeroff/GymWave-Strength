...
const Label = styled.label`
  ...
  font-size: 14px;
  color: #004080;
  margin: -5px 0 4px; /* ↑ ↓ controla espaçamento superior e inferior */
  display: block;
`;
...
const SerieFields = styled.div`
  display: flex;
  flex-direction: column;
  gap: 4px;  /* Espaço entre os campos da mesma série */
  padding-bottom: 12px; /* Dá um respiro antes da próxima série */
