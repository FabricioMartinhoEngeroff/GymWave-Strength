...
- **RG5** – A importação atualiza o plano de treino (`planoTreino`) com as sessões e exercícios da planilha, sobrescrevendo o plano anterior (o plano é um template, não histórico).
